    ...
    return (
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            <img className="
                ...
                h-[12vw]
            "
            src={data.thumbnailUrl} alt='Thunbnail' />
            <div className="
                opacity-0
                absolute
                top-0
                ...
                group-hover:hover:translate-x-[2vw]
                ...
                ">
                    <div className="flex flex-row items-center gap-3">
                        <div className="cursor-pointer w-6 h-6 lg:w-10 lg:h-10 bg-white rounded-full flex justified-center items-center transition hover:bg-neutral-300"
                            onClick={() => router.push(`/watch/${data?.id}`)}>
                                <BsFillPlayFill className="ml-1" size={35} />
                        </div>
